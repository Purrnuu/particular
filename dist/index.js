  ...
  class ParticularWrapper extends Component {
    ...
    render() {
      ...
      return /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx(WrappedComponent, { ...wrappedProps })
      ] });
    }
  }
...
export { Attractor, Camera, CanvasRenderer, Emitter, FlockingForce, MouseForce, Particle, Particular, ParticularWrapper_default as ParticularWrapper, Vector, WebGL3DRenderer, WebGLRenderer, applyCanvasStyles, canvasToDataURL, colorPalettes, configureParticle, createHeartImage, createParticles, createTextImage, defaultCamera, getParticlesBackgroundLayerStyle, getParticlesContainerLayerStyle, particlesBackgroundLayerStyle, particlesContainerLayerStyle, DEFAULT_Z_INDEX as particlesDefaultZIndex, presets, setParticlePoolSize, showFPSOverlay, startScreensaver, useParticles, useScreensaver, withParticles };
