...
}`,...(L=(D=I.parameters)==null?void 0:D.docs)==null?void 0:L.source}}};var A,C,q;v.parameters={...v.parameters,docs:{...(A=v.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: 'Intro — Scale In',
  render: args => {
    const size = Math.min(window.innerWidth, window.innerHeight) * 0.7;
    return <ImageDemo {...args} buildImage={() => ({
...
}`,...(q=(C=v.parameters)==null?void 0:C.docs)==null?void 0:q.source}}};var B,F,K;x.parameters={...x.parameters,docs:{...(B=x.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: 'Intro — Ripple',
  render: args => {
    const size = Math.min(window.innerWidth, window.innerHeight) * 0.7;
    return <ImageDemo {...args} buildImage={() => ({
...
}`,...(K=(F=x.parameters)==null?void 0:F.docs)==null?void 0:K.source}}};var U,V,_;y.parameters={...y.parameters,docs:{...(U=y.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: 'Intro — Paint',
  render: args => {
    const size = Math.min(window.innerWidth, window.innerHeight) * 0.7;
    return <ImageDemo {...args} buildImage={() => ({
...
}`,...(_=(V=y.parameters)==null?void 0:V.docs)==null?void 0:_.source}}};const se=["TextToParticles","Heart","WoltLogo","Viking","IntroScatter","IntroScaleIn","IntroRipple","IntroPaint"];export{h as Heart,y as IntroPaint,x as IntroRipple,v as IntroScaleIn,I as IntroScatter,g as TextToParticles,p as Viking,w as WoltLogo,se as __namedExportsOrder,ae as default};
