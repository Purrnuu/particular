module.exports = (function(t) {
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n, c, s, f) {
      ...
      for (f.set(t, e), f.set(e, t); ++d < p; ) {
        var b = t[d],
          g = e[d];
        if (c) var m = l ? c(g, b, d, e, t, f) : c(b, g, d, t, e, f);
        if (void 0 !== m) {
          if (m) continue;
          y = !1;
          break;
        ...
        if (x) {
          if (
            !o(e, function(t, e) {
              if (!i(x, e) && (b === t || s(b, t, n, c, f))) return x.push(e);
            })
          ) {
            y = !1;
            break;
          }
        } else if (b !== g && !s(b, g, n, c, f)) {
          y = !1;
          break;
        }
      }
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n, y, x, b) {
      var g = c(t),
        m = c(e),
        _ = g ? h : u(t),
        w = m ? h : u(e),
      ...
      if (A && !j)
        return b || (b = new r()), g || f(t) ? o(t, e, n, y, x, b) : i(t, e, _, n, y, x, b);
      if (!(n & l)) {
        ...
        if (O || P) {
          var R = O ? t.value() : t,
            z = P ? e.value() : e;
          return b || (b = new r()), x(R, z, n, y, b);
        }
      }
      return !!A && (b || (b = new r()), a(t, e, n, y, x, b));
    };
  },
  function(t, e, n) {
    var r = n(26),
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n, a, u, c) {
      ...
      for (var y = s; ++p < l; ) {
        var x = t[(h = f[p])],
          b = e[h];
        if (a) var g = s ? a(b, x, h, e, t, c) : a(x, b, h, t, e, c);
        if (!(void 0 === g ? x === b || u(x, b, n, a, c) : g)) {
          d = !1;
          break;
        }
        y || (y = 'constructor' == h);
  ...
  function(t, e, n) {
      ...
      o()(this, t),
        ...
        a()(this, 'update', function() {
          n.velocity.add(n.acceleration),
            ...
            n.velocity.addGravity(0.15),
            n.position.add(n.velocity),
            (n.rotation = n.rotation + n.rotationVelocity),
            (n.factoredSize = Math.min(n.factoredSize + 1, n.size)),
            (n.alpha = Math.max((n.lifeTime - n.lifeTick) / 30, 0)),
            n.lifeTick++,
    ...
    var B = function t(e) {
        var n = this,
          ...
          p = e.sizeMin,
          h = e.sizeMax,
          v = e.velocityMultiplier;
        o()(this, t),
          a()(this, 'emit', function() {
            if (n.isEmitting)
              for (var t = 0; t < n.emitterRate; t++) {
          ...
          a()(this, 'update', function(t, e) {
            ...
            f()(n.particles, function(n) {
              ...
              (n.particles = r),
              (n.isEmitting = n.lifeCycle < n.emitterLife);
          }),
          a()(this, 'isAlive', function() {
            return n.isEmitting || n.particles.length > 0;
          }),
          a()(this, 'createParticle', function() {
            var t = n.velocity.getAngle() + n.spread - Math.random() * n.spread * 2,
              e = n.velocity.getMagnitude(),
              r = new y(n.position.x, n.position.y),
              o = y.fromAngle(t, e),
              i = F(n.sizeMin, n.sizeMax);
            o.add({ x: 0, y: (-(n.sizeMax - i) / 15) * n.velocityMultiplier });
            var a = i / 2e3,
              u = new y(0, i / 100);
            return (
              n.lifeCycle++, new $({ point: r, velocity: o, acceleration: u, friction: a, size: i })
            );
          }),
          a()(this, 'destroy', function() {
            b(n.particles);
    ...
    var q = (function() {
      ...
      V = (function(t) {
        function e(t) {
          ...
          return (
            o()(this, e),
            (n = j()(this, A()(e).call(this, t))),
            a()(P()(n), 'onWindowResize', function() {
              n.particular.onResize();
              var t = window.innerHeight,
                e = window.innerWidth;
              n.setState({ width: e, height: t });
            }),
            a()(P()(n), 'configure', function(t) {
                ...
                n.particular.addEmitter(
                  new B(
                    d()(
                      {
                        point: new y(
                          e / n.configuration.pixelRatio,
                          r / n.configuration.pixelRatio,
                        ),
                        icons: i,
                      },
                      n.configuration,
          ...
          p()(e, [
            {
              ...
              value: function() {
                this.particular || (this.particular = new g()),
      ...
      G = function() {
        ...
        return function(e) {
          var n = t.customIcons,
            r = (function(r) {
              function i() {
                ...
                return (
                  o()(this, i),
                  (t = j()(this, A()(i).call(this))),
                  a()(P()(t), 'burst', function(e) {
                    var r = e.clientX,
                      o = e.clientY,
                      i = e.icons;
                  ...
                  },
                  {
                    ...
                    value: function() {
                      ...
                      return S.a.createElement(
                        ...
                        S.a.createElement(e, _()({}, this.props, { burst: this.burst })),
                      );
                    },
                  },
                ]),
          ...
          return a()(r, 'displayName', 'Particular('.concat(T()(e), ')')), r;
        };
      };
